...
import { SELECT_CURRENCY_POP_UP, SELECT_SERVICE_POP_UP as SELECT_CATEGORY_POP_UP } from '../../../../pop-ups/Constaints'
...
const Services = () => {
    ...
    const [selectedCategory, setSelectedCategory] = useState(
        { symbol: "💎", title: "Instagram Views Emergency Server", value: "ID1" },
    );
    ...
    return (
        <section className='panel-services'>
            ...
            <div className="search">
                <fieldset
                    className={searchInputFocused}
                    onBlur={() => { setSearchInputFocused("") }}
                    onFocus={() => { setSearchInputFocused("focused") }}>
                    <legend>
                        <Icon icon="majesticons:search-line" />
                        <span> Search Service</span>
                    </legend>
                    <div className="box">
                        <input type="text" name='search-query' placeholder='Enter your Service Name....' />
                        <Icon icon="iconamoon:send-fill" />
                    </div>

                </fieldset>
                <div className="filters">
                    <button onClick={openCurrencyPopup}>
                        <Icon icon="ant-design:dollar-outlined" />
                        <span>
                            <small>{selectedCurrency.unit}</small>
                            <small>{selectedCurrency.symbol}</small>
                        </span>
                    </button>
                    <button onClick={openServiceFilterPopUp}>
                        <Icon icon="tabler:category" />
                        <span>
                            <small>{selectedCategory.symbol}</small>
